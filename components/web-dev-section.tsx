...
const projects = [
  {
    ...
    description: "Modern responsive e-commerce site with shopping cart, product filtering, and payment integration.",
    image: "/modern-ecommerce-interface.png",
    technologies: ["React", "Tailwind CSS", "JavaScript", "Stripe"],
    liveUrl: "#",
    githubUrl: "#",
  },
  {
    title: "Portfolio Dashboard",
    description: "Interactive dashboard showcasing projects with smooth animations and responsive design.",
    image: "/task-management-dashboard.png",
    technologies: ["Next.js", "TypeScript", "CSS3", "Framer Motion"],
    liveUrl: "#",
    githubUrl: "#",
  },
  {
    title: "Landing Page",
    description: "High-converting landing page with modern design, animations, and mobile-first approach.",
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
            Specializing in modern web technologies to create scalable, performant, and user-friendly applications that
