...
const services = [
    {
        ...
        description:
            "Professional email handling, organization, and response management to keep your inbox under control.",
    },
    {
        icon: Calendar,
        title: "Schedule Management",
        description:
            "Efficient calendar management, appointment scheduling, and meeting coordination.",
    },
    {
        icon: Briefcase,
        title: "Administrative Tasks",
        description:
            "Data entry, document preparation, research, and general administrative support.",
    },
    {
        icon: Users,
        title: "Customer Support",
        description:
            "Professional customer service, chat support, and client communication management.",
    },
];
            ...
            <div className="container mx-auto px-6">
                <div className="text-center mb-16 animate-fade-in">
                    ...
                    <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                        Providing comprehensive virtual assistance to help
                        businesses streamline operations and focus on growth.
                    </p>
                </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-muted-foreground text-sm">
                                            Available across different time
                                            zones to meet your business needs.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div className="space-y-4">
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-muted-foreground text-sm">
                                            Tailored solutions that fit your
                                ...
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-muted-foreground text-sm">
                                            Wide range of skills to handle
                                            various administrative and support
                                            tasks.
                                        </p>
                                    </div>
                                </div>
