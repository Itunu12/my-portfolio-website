  ...
  return (
    <section className="min-h-screen gradient-bg flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        ></div>
        <div
          className="absolute top-1/2 left-10 w-16 h-16 bg-primary rounded-full animate-float"
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <div className="animate-fade-in">
          ...
          <p className="text-xl md:text-2xl text-white/90 mb-8 font-[family-name:var(--font-open-sans)]">
            Front-End Web Developer | Virtual Assistant
          </p>
          <p className="text-lg text-white/80 mb-12 max-w-2xl mx-auto leading-relaxed">
            Crafting exceptional digital experiences with modern web technologies and providing comprehensive virtual
