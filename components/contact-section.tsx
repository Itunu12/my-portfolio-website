            ...
            <div className="container mx-auto px-6">
                <div className="text-center mb-16 animate-fade-in">
                    ...
                    <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                        Ready to start your next project or need virtual
                        assistance? I'd love to hear from you and discuss how we
                        can work together.
                    </p>
                </div>
                        ...
                        <Card className="shadow-xl">
                            <CardContent className="p-8">
                                ...
                                <div className="flex space-x-4">
                                    ...
                                    >
                                        <a
                                            href="https://www.linkedin.com/in/kazeem-itunu"
                                            target="_blank"
                                ...
                                <div className="mt-6 p-4 bg-muted/50 rounded-lg">
                                    <p className="text-sm text-muted-foreground leading-relaxed">
                                        <strong>Response Time:</strong> I
                                        typically respond to all inquiries
